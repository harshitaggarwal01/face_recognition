...
harshit_image = face_recognition.load_image_file("harshit.jpg")
...
nm_image = face_recognition.load_image_file("nm.png")
nm_face_encoding = face_recognition.face_encodings(nm_image)[0]

#payal_image = face_recognition.load_image_file("payal.png")
